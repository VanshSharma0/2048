  ...
  return (
    <div className={styles.twenty48}>
      ...
      <footer>
        ...
        <a href="https://vansh.site" target="_blank" rel="noopener">
            <Image
              src="social-portfolio.svg"
              alt="My Portfolio"
              width={32}
              height={32}
            />
          ...
          <a href="https://www.linkedin.com/in/vansh-sharma0/" target="_blank" rel="noopener">
            <Image
